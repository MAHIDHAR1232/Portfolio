export default function Header() {
    return (
        <div className="w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4">
            <img src="./assets/bro-modified-min.png" alt="" className="rounded-full w-32" />
            ...
            <p className="max-w-2xl mx-auto font-Ovo">
                Driven by curiosity and innovation, I specialize in crafting seamless end-to-end digital experiences using the MERN stack.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 mt-4">
                ...
                <a href="./assets/MAHIDHAR_RESUME.pdf" download
